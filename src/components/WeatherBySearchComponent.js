...
import { storeData, getData } from "../utils/AsyncStorage";
  ...
  const WeatherBySearchComponent = (params) => {
          ...
          loading ? (
            ...
            <View style={{ width: windowWidth, height: windowHeight }}>
              ...
              <View style={{ justifyContent: "space-around", flex: 1 }}>
                {/*Location*/}
                <View style={{ height: windowHeight / 15, margin: 15, zIndex: 1 }}>
                  <View style={{
                    ...
                    <TouchableOpacity
                      ...
                      style={{ backgroundColor: "rgba(255,255,255,0.3)", borderRadius: 20, padding: 10, margin: 4 }}
                    >
                            ...
                            return (
                              <TouchableOpacity
                                ...
                                style={[{
                                  ...
                                  paddingLeft: 15,
                                  borderColor: "#BDBDBD",
                                }, index + 1 !== locations.length && { borderBottomWidth: 2 }]}>
                ...
                <View style={{ marginVertical: windowWidth / 30 }}>
                  ...
                  <Text style={{ textAlign: "center", fontWeight: "bold", color: "white", fontSize: 60 }}>
                    {current?.temp_c}&#176;
                  </Text>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", marginHorizontal: "4%" }}>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Image
                      style={{ width: windowWidth / 20, aspectRatio: 1, marginHorizontal: 6 }}
                      source={require("../assets/icons/wind.png")} />
                    <Text style={{ color: "white", fontWeight: "semibold" }}>{current?.wind_kph}km</Text>
                  </View>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Image
                      style={{ width: windowWidth / 20, aspectRatio: 1, marginHorizontal: 6 }}
                      source={require("../assets/icons/drop.png")} />
                    <Text style={{ color: "white", fontWeight: "semibold" }}>{current?.humidity}%</Text>
                  </View>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Image
                      style={{ width: windowWidth / 20, aspectRatio: 1, marginHorizontal: 6 }}
              ...
              <View style={{ marginBottom: windowHeight / 20, marginVertical: "3%" }}>
                <View
                  style={{
                    flexDirection: "row",
                    alignItems: "center",
                  ...
                  <Text style={{ color: "white", marginHorizontal: "3%" }}>Next Three Days Forecast</Text>
                </View>
                    ...
                    weather?.forecast?.forecastday?.map((item, index) => {
                      ...
                      return (
                        <View
                          ...
                          <Image source={{uri: "https:" + imageUrl}}
