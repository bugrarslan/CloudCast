  ...
  const WeatherByLocationComponent = (props) => {
    ...
    const fetchLocation = () => {
      ...
      Geolocation.watchPosition(
        ...
        { enableHighAccuracy: true, maximumAge: 10000, fastestInterval:30000 , interval:30000}
      );
    }
              ...
              <View style={{ justifyContent: "space-around", flex: 1 }}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", marginHorizontal: "4%" }}>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    ...
                    <Text style={{ color: "white", fontWeight: "semibold" }}>{weather?.current?.wind_kph}km</Text>
                  </View>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Image
                      style={{ width: windowWidth / 20, aspectRatio: 1, marginHorizontal: 6 }}
                      source={require("../assets/icons/drop.png")} />
                    <Text style={{ color: "white", fontWeight: "semibold" }}>{weather?.current?.humidity}%</Text>
                  </View>
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Image
                      style={{ width: windowWidth / 20, aspectRatio: 1, marginHorizontal: 6 }}
